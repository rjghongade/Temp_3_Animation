              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#312223]/80 text-[#d1b578] border ${formErrors.first_name
                        ? "border-red-500"
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-[#312223]/80 text-[#d1b578] border ${formErrors.last_name
                        ? "border-red-500"
                        : "border-[#312223]/50 group-focus-within:border-[#5f7858]"
                      } rounded-xl pl-12 p-4 focus:outline-none transition-all`}
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-[#312223]/80 text-[#d1b578] border ${formErrors.email_id
                        ? "border-red-500"
                        : "border-[#312223]/50 group-focus-within:border-[#5f7858]"
                      } rounded-xl pl-12 p-4 focus:outline-none transition-all`}
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-[#312223]/80 text-[#d1b578] border ${formErrors.phone_number
                        ? "border-red-500"
                        : "border-[#312223]/50 group-focus-within:border-[#5f7858]"
                      } rounded-xl pl-12 p-4 focus:outline-none transition-all`}
            ...
            <div className="mb-8">
              ...
              <div className="relative group">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="5"
                  className={`w-full bg-[#312223]/80 text-[#d1b578] border ${formErrors.message
                      ? "border-red-500"
                      : "border-[#312223]/50 group-focus-within:border-[#5f7858]"
                    } rounded-xl pl-12 p-4 focus:outline-none transition-all`}
