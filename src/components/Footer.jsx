...
<footer className="bg-[#170505] text-[#d1b578] border-t border-[#312223]">
    ...
    <div>
      ...
      <ul className="space-y-3">
        {["Our Projects", "Why Choose Us"].map((link, i) => (
          <li key={i}>
            <a href="#PropertiInfo" className="text-[#d1b578] hover:text-[#5f7858] transition-all">
              {link}
            </a>
          </li>
        ))}
      ...
      <ul className="space-y-3">
        {g_setting.footer_phone && (
          <li className="flex items-center justify-center md:justify-start">
            ...
            <a href={`tel:${g_setting.footer_phone}`} className="text-[#d1b578] hover:text-[#5f7858] transition-all">
              {g_setting.footer_phone}
            </a>
          </li>
        )}
  ...
  <div className="border-t border-[#312223] mt-6 py-6 bg-[#170505]/80 text-center">
    ...
    <a href="/" className="text-[#d1b578] hover:text-[#5f7858] transition-all">Privacy Policy</a>
  </div>
